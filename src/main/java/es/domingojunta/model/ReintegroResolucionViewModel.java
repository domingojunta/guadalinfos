...
public class ReintegroResolucionViewModel {
	...
	private String antecedente07;
	private String antecedente08;
	private String propone01;
	private String parrafoAnexoAlegaciones;
	private BigDecimal interesesDeDemora;
	...
	public ReintegroResolucionViewModel() {
		super();
	...
	public String getAntecedente07() {
		return antecedente07;
	}


	public void setAntecedente07(String antecedente07) {
	...
	public String getAntecedente08() {
		return antecedente08;
	}


	public void setAntecedente08(String antecedente08) {
		this.antecedente08 = antecedente08;
	}


	public String getParrafoAnexoAlegaciones() {
		return parrafoAnexoAlegaciones;
	}


	public void setParrafoAnexoAlegaciones(String anexoAlegaciones) {
		this.parrafoAnexoAlegaciones = anexoAlegaciones;
	}

	public BigDecimal getInteresesDeDemora() {
		return interesesDeDemora;
	}


	public void setInteresesDeDemora(BigDecimal interesesDeDemora) {
		this.interesesDeDemora = interesesDeDemora;
	}
	...
	public BigDecimal getCoste() {
		return this.costeResolucionConcesion;
	}
	
	public BigDecimal getSubvencion() {
		return this.subvencionResolucionConcesion;
	}
	...
	public void setParrafoInformacion() {
		...
		sb.append("\n");
		sb.append("Asunto: Remisión Resolución de Reintegro");
		sb.append("\n");
	...
	public void setParrafoNormativa() {
		...
		StringBuilder sb = new StringBuilder();
		sb.append("Adjunto se remite Resolución de Reintegro de las cantidades indebidamente percibidas corespondientes ");
		sb.append("a la subvención concedida en el marco de la ");
	...
	public void setParrafoDatosSubvencion() {
		...
		public void setAntecedente06() throws ParseException {
			...
			sb.append("\n\n");
			sb.append("De todo lo anterior se deduce que no se ha cumplido la totalidad de las obligaciones establecidas, ");
			sb.append("concretamente, tras la comprobación de la justificación presentada y la aplicación de los criterios ");
			sb.append("de revisión citados anteriormente, resulta un importe cobrado y no justificado que deberá de reintegrar que asciende a ");
			sb.append(formatCurrency(getResultadoLiquidacion()));
			sb.append(" €, (el importe negativo implica cantidad a reintegrar), mas los intereses de demora devengados desde el momento del ");
			sb.append("primer pago de la subvención: ");
			sb.append(formatDate(getFechaPagoMaterialOJ()));
			sb.append(" hasta la fecha de la presente resolución.");
			
								
			this.antecedente06 = sb.toString();
		}
		
		public void setAntecedente07() throws Exception {
			StringBuilder sb = new StringBuilder();
		...
		public void setAntecedente08() throws Exception {
			StringBuilder sb = new StringBuilder();
			sb.append("Octavo.- Con fecha ");
			sb.append(formatDate(getFechaAcuerdoInicioReintegro()));
			sb.append(" se acuerda el inicio de un procedimiento de reintegro de cantidades indebidamente percibidas,");
			sb.append("debidamente notificado a través de la plataforma telemática.");
			sb.append("\n\n");
			sb.append("Noveno.- Las alegaciones presentadas, en su caso, por la Entidad serán analizadas en el Anexo ");
			sb.append("de alegaciones de la presente resolución");
			
					
			this.antecedente08 = sb.toString();
	...
	public void generarCalculosLiquidacion() {
		...
		BigDecimal resultadoLiquidacionRedondeado = getResultadoLiquidacion().setScale(2, BigDecimal.ROUND_HALF_EVEN);
		setInteresesDeDemora(getImporteModelo022().subtract(resultadoLiquidacionRedondeado));
	...
	public void setParrafoAnexoAlegaciones() throws Exception {
		StringBuilder sb = new StringBuilder();
		if (getFechaAcuerdoInicioReintegro()== null || getFechaAcuerdoInicioReintegro().equals("")) {
			sb.append("Habiendo transcurrido en exceso el plazo dado para la presentación de alegaciones, ");
			sb.append("no existe constancia en esta Delegación Territorial, que las mismas hayan sido presentadas.");
		} else {
			sb.append("Con fecha ");
			sb.append(formatDate(getFechaAlegacionesAIR()));
			sb.append(" la Entidad manifiesta su conformidad con la propuesta de liquidación notificada y su intención de no ");
			sb.append("presentar alegaciones a la misma.");
		}
		
				
		this.parrafoAnexoAlegaciones = sb.toString();
