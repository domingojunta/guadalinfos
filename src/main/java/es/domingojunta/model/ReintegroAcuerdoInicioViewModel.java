...
public class ReintegroAcuerdoInicioViewModel {
	...
	public ReintegroAcuerdoInicioViewModel() {
		super();
	...
	public void setParrafoInformacion() {
		...
		sb.append("\n");
		sb.append("Asunto: Remisión Acuerdo Inicio de Reintegro");
		sb.append("\n");
	...
	public void setParrafoNormativa() {
		...
		StringBuilder sb = new StringBuilder();
		sb.append("Adjunto se remite Acuerdo de Inicio de Reintegro de las cantidades indebidamente percibidas corespondientes ");
	...
	public void setAntecedente07() throws Exception {
		...
		sb.append(" se dictó resolución de liquidación de la subvención descrita en el encabezado de la presente resolución, ");
