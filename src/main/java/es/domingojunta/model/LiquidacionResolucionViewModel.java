...
public class LiquidacionResolucionViewModel {
	...
	private String tipoAlegaciones;
	...
	private String parrafoAnexoPresupuesto;
	...
	public LiquidacionResolucionViewModel() {
		super();
	...
	public String getTipoAlegaciones() {
		return tipoAlegaciones;
	}


	public void setTipoAlegaciones(String tipoAlegaciones) {
		this.tipoAlegaciones = tipoAlegaciones;
	}
	...
	public String getParrafoAnexoPresupuesto() {
		return parrafoAnexoPresupuesto;
	}


	public void setParrafoAnexoPresupuesto(String parrafoAnexoPresupuesto) {
		this.parrafoAnexoPresupuesto = parrafoAnexoPresupuesto;
	}
	...
	public void setParrafoAnexoAlegaciones(String parrafoAnexoAlegaciones) {
		this.parrafoAnexoAlegaciones = parrafoAnexoAlegaciones;
	}
	...
	public void setParrafoInformacion() {
		...
		sb.append("\n");
		sb.append("Asunto: Remisión Resolución de Liquidación");
		sb.append("\n");
	...
	public void setParrafoNormativa() {
		...
		StringBuilder sb = new StringBuilder();
		sb.append("Adjunto se remite Resolución de Liquidación de la subvención concedida en el marco de la ");
	...
	public void setParrafoDatosSubvencion() {
		...
		public void setPropone02() throws Exception {
			...
			if (this.perdidaDerechoAlCobro.floatValue()==0) {
				...
				sb.append(" euros.");
				sb.append("\n\n");
				sb.append("CUARTO.- Contra la presente resolución, que pone fin a la vía administrativa, se podrá interponer recurso ");
				sb.append("potestativo de reposición ante esta Delegación Territorial, en el plazo de UN MES contado a partir del día "); 
				sb.append("siguiente a aquel en que tenga lugar la notificación o publicación del presente acto, o interponer "); 
				sb.append("directamente el recurso contencioso administrativo ante los correspondientes órganos judiciales, en el "); 
				sb.append("plazo de DOS MESES contados desde el día siguiente al de la notificación de este acto, todo ello de ");
		...
		public void setParrafoAnexoPresupuesto() throws Exception {
			...
			this.parrafoAnexoPresupuesto = sb.toString();
		}
	...
	public void setAntecedente07() throws Exception {
		...
		sb.append(formatDate(getFechaPropuestaLiquidacion()));
	...
	public void setParrafoAnexoAlegaciones() throws Exception {
		StringBuilder sb = new StringBuilder();
		if (getFechaAlegacionesPropuestaLiquidacion()== null || getFechaAlegacionesPropuestaLiquidacion().equals("")) {
			...
			sb.append("Con fecha ");
			sb.append(formatDate(getFechaAlegacionesPropuestaLiquidacion()));
